                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Recorded Budget</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₱ {{number_format($budget,2,'.',',')}}</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body text-danger">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₱ {{number_format($cost,2,'.',',')}}</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body text-info">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{number_format((float)$consumed, 1, '.', '')}}%</div>
                                                </div>
                                                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6  d-none d-lg-block">
                            <div class="card shadow mb-4 w-100">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Weekly Reports for Week 33</h6>
                                    <!-- <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-interval="false">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item p-3" style="background-color:#f5f5f5">
                                                <div class="row">
                                                    <div class="col-lg-12 mb-3 mt-3">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <h3><b>
                                                                                Project Moses <i class="fa-solid fa-circle" style="color:red"></i>
                                                                                </b></h3>
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                                <h6>August 3 - August 10</h6>
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                                <h5><b>Executive Summary:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</h5>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 mb-1">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="progress" class=" form-control" value="43%" disabled>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-1">
                                                                                <div class="form-group">
                                                                                    <label for="workweek">Work Week</label>
                                                                                    <input type="text" name="workweek" class=" form-control" value="33" disabled>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-1">
                                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="risks" class="form-control" rows="5" disabled></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <h4><label for="nextsteps">Project Next Steps</label></h4>
                                                                    <textarea name="nextsteps" class="form-control" rows="5" disabled></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <h4><label for="help">Project Help Needed</label></h4>
                                                                    <textarea name="help" class="form-control" rows="5" disabled></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="carousel-item p-3 active" style="background-color:#f5f5f5">
                                                <div class="row">
                                                    <div class="col-lg-12 mb-3 mt-3">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <h3><b>
                                                                                Project Genesis <i class="fa-solid fa-circle" style="color:green"></i>
                                                                                </b></h3>
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                                <h6>August 3 - August 10</h6>
