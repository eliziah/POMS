...
@section('title', 'Add External Project')
@section('content')
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" cols="10" rows="5" placeholder="Project Description">{{old('description')}}</textarea>
                      @error('description')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      ...
                      <select name="sponsor_sub" id="sponsor_sub" class="form-control @error('sponsor_sub') is-invalid @enderror" value="{{old('sponsor_sub')}}" readonly>
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label for="sponsor_name">Client Name</label>
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label for="sponsor_dept">Implementing Department</label>
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="date" step=".01" name="p_close" class="form-control @error('p_close') is-invalid @enderror" id="p_close" placeholder="End Date" value="{{old('p_close')}}" required>
                      @error('p_close')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label for="artifact">Project Contract</label>
